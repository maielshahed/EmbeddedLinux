...
class LaneDetector:
    ...
    def check_car_position(self, frame):  
        ...
        return occupation_ratio > 0.1  # Adjust this threshold as needed return boolen
    ...
    def draw_parking_guidelines(self, frame):
        ...
        left_top = (int(width * 0.35), int(height * 0.3))        # Adjusted from 0.15 to 0.35
        right_top = (int(width * 0.65), int(height * 0.3))       # Adjusted from 0.85 to 0.65
        left_bottom = (int(width * 0.2), height)                 # Adjusted from 0 to 0.2
        right_bottom = (int(width * 0.8), height)                # Adjusted from width to 0.8
        
        # Center vertical line
        center_top = (int(width * 0.5), int(height * 0.3))      # Adjusted center line
        ...
        cv2.line(frame, (int(width * 0.2), int(height * 0.3)),  (int(width * 0.8), int(height * 0.3)), line_color, 2)  # Top line
...
class CameraThread(QThread):
    ...
    car_position_changed = pyqtSignal(bool)

    def __init__(self, video_path, target_width=500, target_height=245):
        super().__init__()
        self._running = True
...
#----------------------------------------------------------------------------------------//
    ...
    def setup_camera_section(self):
        ...
        self.camera_width=int(500)
        self.camera_height=int(245)
...
#***************************************************************************#
    def toggle_lights(self):
        ...
        GPIO.setup(16, GPIO.OUT)        # Set GPIO 18 as an output pin
...
#***************************************************************************#
    def start_camera_feed(self):
        ...
        #video_path = (0)
        # Create camera thread with the correct dimensions
